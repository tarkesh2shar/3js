...
import ImageIn3D from '../../../assets/cat.jpg';
...
export default function canvas({ image }) {
  ...
  useEffect(() => {
    ...
    // canvasContainer.current.addEventListener('contextmenu', function(ev) {
    //     ev.preventDefault();
    //     alert('success!');
    //     return false;
    // }, false);
...
//     var imgObject = new CSS3DObject( image );

//     //random position at the start thats so awesome !!!!
// imgObject.position.x = Math.random() * 4000 - 2000;
// imgObject.position.y = Math.random() * 4000 - 2000;
// imgObject.position.z = Math.random() * 4000 - 2000;
...
//////////////////some crazy bit of codes calm down !!!!!!!!
    var element = document.createElement( 'img' );
    element.src = ImageIn3D;
    ...
    cssObject.position.copy(camera.target )
    scene.add(cssObject);
